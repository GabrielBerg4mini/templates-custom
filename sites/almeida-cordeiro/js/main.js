...
// Aqui só ficam: reveal-on-scroll (Bootstrap não tem), o ano do rodapé, o
// fechamento do menu mobile ao clicar em um link, e o placeholder do
...
function initMobileNavClose() {
  ...
  collapseEl.querySelectorAll('.nav-link, .btn-line').forEach((link) => {
