...
// Bootstrap (navbar, collapse do menu mobile, etc.) já cuida de si mesmo
// via data-bs-*. Aqui só ficam: reveal-on-scroll e o acordeão de FAQ
// (Bootstrap não tem nenhum dos dois prontos do jeito que a direção pede).
